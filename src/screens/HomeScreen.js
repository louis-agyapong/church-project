    ...
    header.addEventListener("click", function () {
      ...
      if (accordionMaxHeight === "0px" || accordionMaxHeight.length === 0) {
        accordionContent.style.maxHeight = `${
          accordionContent.scrollHeight + 40
        }px`;
    ...
    <div className="w-full h-full bg-[#ffffff] max-w-[2010px] m-auto">
        ...
        <div className="w-full h-screen mt-16 relative overflow-hidden flex flex-col items-center justify-center">
          <div className="w-full h-full relative z-30 bg-[#2E4378] flex flex-col items-center justify-center  bg-opacity-60">
            <div className="w-full flex justify-center items-center space-x-5 md:space-x-10 mt-10 px-4">
              <p className="text-4xl md:text-8xl lg:text-9xl text-white  AchivoMedium">
                WELCOME!
              </p>
            </div>
            <a
      ...
      >
        ...
        <p className="AchivoRegular font-normal mt-5 text-lg md:text-xl text-center md:w-11/12 lg:w-7/12 ">
          Be a part of a community that is passionate about God and are on a
          mission to connect the heart of God to the heart of the people
        </p>
        <div className="w-full h-full flex justify-center gap-10 lg:my-20 mt-5">
          ...
          >
            ...
            <div className="absolute w-full h-full flex flex-col items-center justify-center bg-[#59d8d2]  transition-colors duration-1000 bg-opacity-60 hover:bg-opacity-80">
              ...
              <p className="text-xl AchivoRegular text-white font-semibold">
                {" "}
                Be part of a team
              </p>
            </div>
      ...
      >
        <div className="w-full h-full grid md:grid-cols-2 gap-14 lg:my-20 mt-5">
          <div className="w-full h-full hidden md:flex items-center justify-center rounded-lg overflow-hidden shadow-lg">
            <img
          ...
          <div className="w-full h-full flex flex-col items-center md:items-start justify-center">
            <h3 className="text-4xl font-semibold text-gray-800 my-4">
              Campus Ministry
            </h3>
            <p className="text-lg font-normal text-center md:text-left mt-6 md:w-11/12">
              GIMPA Campus Ministry is a vibrant community of believers who are
              committed to sharing the love of Christ with students and staff on
              campus. Led by passionate and dedicated leaders, the ministry
              seeks to create a welcoming environment where individuals can grow
              in their faith and connect with others who share their beliefs.
            </p>
            <p className="text-lg font-normal mt-8 mb-2 md:text-xl md:w-11/12 hidden lg:block">
              Through various activities such as Bible studies, prayer meetings,
              and outreach programs, the GIMPA Campus Ministry seeks to impact
              the lives of those within the university community and beyond.
            </p>
          </div>
          <div className="w-full h-96 md:hidden flex items-center justify-center rounded-lg overflow-hidden shadow-lg">
            <img
              className="object-cover w-full h-full"
      ...
      >
          ...
          <div className="bg-white p-10 shadow-sm">
            ...
            <div className="transition hover:bg-indigo-50">
              ...
              <div className="accordion-content px-5 pt-0  overflow-hidden max-h-0">
                <p className=" AchivoThin pl-9 text-justify">
                  There are many ways to get involved. You can begin by signing
                  up to get updates about the launch of the Waterbrook.
                  Secondly, you can make a difference by being a part of the
                  launch team. Just fill out an interest form{" "}
                  <a
                    hreaf="/group#launch"
            ...
            <div className="transition hover:bg-indigo-50">
              ...
              <div className="accordion-content px-5  pt-0 overflow-hidden max-h-0">
                <p className="leading-6 AchivoThin pl-9 text-justify">
                  Every weekend, you will have a great experience filled with an
                  engaging service that lasts about 75 minutes. An inspiring and
                  relevant message. Amazing live worship music. A welcoming and
                  friendly atmosphere. An amazing Brook Kids experience that
            ...
            <div className="transition hover:bg-indigo-50">
              ...
              <div class="accordion-content px-5 pt-0 overflow-hidden max-h-0">
                <p className="leading-6 AchivoThin pl-9 text-justify">
                  At Brook Kids, we believe in building the next generation of
                  pace setters. Every service experience is tailor-made to reach
                  your child at their level. Not only will they have fun, but
                  they will learn the fundamentals of the Christian faith. Upon
                  arrival at church, you will be able to check in your child at
                  the Brook Kids station. Your child will then be led to their
                  classroom and taken care of by background-checked volunteers.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="w-full flex flex-col  items-center mb-10 lg:mt-20 pt-16 lg:pt-0 justify-center lg:px-32 px-5">
          ...
          <p className="AchivoRegular font-normal mt-5 text-lg md:text-xl text-center md:w-11/12 lg:w-full ">
            ...
            eos optio exercitationem eaque
          </p>
          <div className="w-full   h-full grid md:grid-cols-2  gap-14 lg:my-20 mt-5">
